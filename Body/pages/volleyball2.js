...
function badmintonscorecard1(){
    ...
    else if(player1score==23 && player2score==24){
        player2score=player2score-1;
    }
    else if(player1score<25 && player2score<23){
        player1score=player1score+1;
    }
    else if(player1score==23 && player2score==23){
        player1score=player1score+1;
    }
    else if(player1score==24 && player2score==23){
        player1score=player1score+1;
    }
    if(player1score==25){
...
function badmintonscorecard2(){
    ...
    else if(player2score==23 && player1score==24){
        player1score=player1score-1;
    }
    else if(player2score<25 && player1score<23){
        player2score=player2score+1;
    }
    else if(player2score==23 && player1score==23){
        player2score=player2score+1;
    }
    else if(player2score==24 && player1score==23){
        player2score=player2score+1;
    }
    if(player2score==25){
